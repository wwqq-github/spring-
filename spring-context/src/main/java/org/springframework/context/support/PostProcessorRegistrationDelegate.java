...
final class PostProcessorRegistrationDelegate {
	...
	public static void invokeBeanFactoryPostProcessors(
		...
		//beanFactory是DefaultListableBeanFactory的类型 是 BeanDefinitionRegistry的实现类
		//会执行if里面的代码
		if (beanFactory instanceof BeanDefinitionRegistry) {
			BeanDefinitionRegistry registry = (BeanDefinitionRegistry) beanFactory;
			List<BeanFactoryPostProcessor> regularPostProcessors = new ArrayList<>();
			List<BeanDefinitionRegistryPostProcessor> registryProcessors = new ArrayList<>();
			//遍历所有的BeanFactoryPostProcessor类
			// 判断是不是BeanDefinitionRegistryPostProcessor类型的 如果是 就执行BeanDefinitionRegistryPostProcessor.postProcessBeanDefinitionRegistry(registry);
			...
			//先将BeanDefinitionRegistryPostProcessor实现了的类初始化
		...
		// uninitialized to let the bean factory post-processors apply to them!
		//未初始化，让Bean工厂后处理器对其应用！
		//获取所有的BeanFactoryPostProcessor类型的名字
		//得到所有的FactoryBean的子接口实现类
		String[] postProcessorNames =
	...
	public static void registerBeanPostProcessors(
		...
		// Register BeanPostProcessorChecker that log
		//注册该日志的BeanPostProcessorChecker
		// s an info message when
		...
		// Ordered, and the rest.
		////将实现PriorityOrdered，Ordered的BeanPostProcessor和其余的实现分开。
		...
		sortPostProcessors(priorityOrderedPostProcessors, beanFactory);
		//把实现了priorityOrdered接口的实现类添加到容器
